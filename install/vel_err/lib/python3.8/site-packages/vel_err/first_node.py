...
#        self.dis_pos_fil.close()
    ...
    def save_disherder(self, disherder):
        self.dis_fil.write(f'{disherder.linear.x},{disherder.linear.y},{disherder.linear.z},{disherder.angular.z}\n')
    ...
    def callback_velocities_request(self, msg):
        ...
        self.save_disherder(msg.velocity)
        self.save_volsty(respons.error_velocity)
