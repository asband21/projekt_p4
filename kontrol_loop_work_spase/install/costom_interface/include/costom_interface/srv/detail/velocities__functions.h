...
#ifndef COSTOM_INTERFACE__SRV__DETAIL__VELOCITIES__FUNCTIONS_H_
#define COSTOM_INTERFACE__SRV__DETAIL__VELOCITIES__FUNCTIONS_H_
...
/// Initialize srv/Velocities message.
/**
...
/// Finalize srv/Velocities message.
/**
...
/// Create srv/Velocities message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * costom_interface__srv__Velocities_Request__init().
...
/// Destroy srv/Velocities message.
/**
 * It calls
 * costom_interface__srv__Velocities_Request__fini()
...
/// Check for srv/Velocities message equality.
/**
...
/// Initialize array of srv/Velocities messages.
/**
...
/// Finalize array of srv/Velocities messages.
/**
 * It calls
 * costom_interface__srv__Velocities_Request__fini()
...
/// Create array of srv/Velocities messages.
/**
 * It allocates the memory for the array and calls
 * costom_interface__srv__Velocities_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Velocities messages.
/**
 * It calls
 * costom_interface__srv__Velocities_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Velocities message array equality.
/**
...
/// Copy an array of srv/Velocities messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * costom_interface__srv__Velocities_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_costom_interface
...
/**
 * It calls
 * costom_interface__srv__Velocities_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_costom_interface
...
/**
 * It allocates the memory for the array and calls
 * costom_interface__srv__Velocities_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_costom_interface
...
/**
 * It calls
 * costom_interface__srv__Velocities_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COSTOM_INTERFACE__SRV__DETAIL__VELOCITIES__FUNCTIONS_H_
