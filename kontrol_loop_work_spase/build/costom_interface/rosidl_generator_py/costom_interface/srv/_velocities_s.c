...
bool costom_interface__srv__velocities__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("costom_interface.srv._velocities.Velocities_Request", full_classname_dest, 51) == 0);
  }
  costom_interface__srv__Velocities_Request * ros_message = _ros_message;
  {  // velocity
  ...
  {  // position
    ...
    if (!geometry_msgs__msg__twist__convert_from_py(field, &ros_message->position)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of Velocities_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("costom_interface.srv._velocities");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Velocities_Request");
  ...
  {  // position
    PyObject * field = NULL;
    field = geometry_msgs__msg__twist__convert_to_py(&ros_message->position);
    if (!field) {
      return NULL;
    }
    {
...
{
  /* NOTE(esteve): Call constructor of Velocities_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("costom_interface.srv._velocities");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Velocities_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
