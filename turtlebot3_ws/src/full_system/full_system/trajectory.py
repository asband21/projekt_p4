...
class Trajectory(Node):
    ...
    def test_calculate_trajectory(self,coord1, coord2, max_velocity=1):
        """
    ...
    def test_desired_pose(self, t, c):
    ...
    def FindAtoB(self,request,response_request):
        ...
        t,axis = self.test_calculate_trajectory(start_pose,end_pose,0.9)
        ...
        while current_time-start_time < t :
            ...
            numbers = self.test_desired_pose(dt,axis)
