...
static const _WantedVelocities_type_support_symbol_names_t _WantedVelocities_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, costom_interface, msg, WantedVelocities)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, costom_interface, msg, WantedVelocities)),
  }
};
...
{
  return &::costom_interface::msg::rosidl_typesupport_cpp::WantedVelocities_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, costom_interface, msg, WantedVelocities)() {
  return get_message_type_support_handle<costom_interface::msg::WantedVelocities>();
}
